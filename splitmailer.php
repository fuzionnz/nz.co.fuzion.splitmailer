 ...
 */
function splitmailer_civicrm_xmlMenu(&$files) {
  _splitmailer_civix_civicrm_xmlMenu($files);
}
 ...
 */
function splitmailer_civicrm_postInstall() {
  _splitmailer_civix_civicrm_postInstall();
}
 ...
 */
function splitmailer_civicrm_uninstall() {
  _splitmailer_civix_civicrm_uninstall();
}
 ...
 */
function splitmailer_civicrm_disable() {
  _splitmailer_civix_civicrm_disable();
}
 ...
 */
function splitmailer_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  return _splitmailer_civix_civicrm_upgrade($op, $queue);
}
 ...
 */
function splitmailer_civicrm_managed(&$entities) {
  _splitmailer_civix_civicrm_managed($entities);
}
 ...
 */
function splitmailer_civicrm_caseTypes(&$caseTypes) {
  _splitmailer_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function splitmailer_civicrm_angularModules(&$angularModules) {
  _splitmailer_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function splitmailer_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
  _splitmailer_civix_civicrm_alterSettingsFolders($metaDataFolders);
}
 ...
 */
function splitmailer_civicrm_entityTypes(&$entityTypes) {
  _splitmailer_civix_civicrm_entityTypes($entityTypes);
}

/**
 * Implements hook_civicrm_thems().
 */
function splitmailer_civicrm_themes(&$themes) {
  _splitmailer_civix_civicrm_themes($themes);
}
 ...
 *
function splitmailer_civicrm_preProcess($formName, &$form) {
